...
class MachineListAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = inflater.inflate(R.layout.item_machine, parent, false)
            holder = ViewHolder()
            ...
            holder.machineCardContent = view.findViewById(R.id.machineCardContent)
            view.tag = holder
        } else {
            view = convertView
        ...
        // Set any additional styling as needed
    ...
    private class ViewHolder {
        ...
        lateinit var machineCardContent: LinearLayout
    }
}